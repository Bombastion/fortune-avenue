...
/** What a computer player decided to do with one of the [StockTradeOffer]s it was given -- see [ComputerPlayer.chooseStockTrade]. */
 ...
 * that's picking a path at a branch (randomly), deciding whether to buy
 * an unowned shop it lands on (based on whether it can afford it), and
 * deciding whether to trade stock at a BANK space it passes or lands on
 * (no real policy yet -- see [chooseStockTrade]), but this is meant to be
 * where other kinds of computer decisions land too as the game grows
 * (choosing what to do with a card draw, etc.) rather than having "what a
 * computer does" spread across GameSimulationService.
 */
...
class RandomComputerPlayer : ComputerPlayer {
	...
	override fun chooseStockTrade(offers: List<StockTradeOffer>, currentGold: Int): StockTradeDecision? = null
}
