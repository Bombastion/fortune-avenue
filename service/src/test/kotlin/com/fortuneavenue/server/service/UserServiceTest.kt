...
/**
 * Exercises UserService with a mocked UserDao — no Spring context and no
 * database involved, so this stays fast and keeps working even if the
 * controller or the DAO's persistence details change independently.
 */
